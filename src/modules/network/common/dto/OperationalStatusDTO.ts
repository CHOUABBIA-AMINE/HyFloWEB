/**
 * OperationalStatus DTO - Network Common Module
 * 
 * Strictly aligned with backend: dz.sh.trc.hyflo.network.common.dto.OperationalStatusDTO
 * 
 * Represents operational status of network entities (operational, maintenance, out of service, etc.)
...
/**
 * Validates OperationalStatusDTO according to backend constraints
 */
export const validateOperationalStatusDTO = (data: Partial<OperationalStatusDTO>): string[] => {
  const errors: string[] = [];
