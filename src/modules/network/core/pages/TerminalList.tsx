/**
 * Terminal List Page - SIMPLIFIED PATTERN - SERVER-SIDE SEARCH ONLY
 * 
 * Features:
...
const TerminalList = () => {
  ...
  const handleExportCSV = () => {
    exportToCSV(terminals, {
      filename: 'terminals-export',
    ...
    <Box>
        ...
        <Box sx={{ p: 2.5 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                {t('terminal.subtitle', 'Manage terminal facilities and storage locations')}
              </Typography>
            </Box>
            ...
            <Stack direction="row" spacing={1.5}>
              ...
              <Tooltip title={t('action.create', 'Create')}>
                <IconButton onClick={() => navigate('/network/core/terminals/create')} size="medium" color="primary">
                  <AddIcon />
                </IconButton>
              </Tooltip>
            </Stack>
      ...
      <Paper elevation={0} sx={{ mb: 3, border: 1, borderColor: 'divider' }}>
        <Box sx={{ p: 2.5 }}>
          <Stack spacing={2.5}>
            <TextField
              placeholder={t('terminal.searchPlaceholder', 'Search by code or name...')}
              value={searchText}
