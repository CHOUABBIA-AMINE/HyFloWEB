      ...
      renderCell: (params) => (
        <Box sx={{ display: 'flex', gap: 0.5 }}>
          <Tooltip title={t('common.edit')}>
            <IconButton size="small" onClick={() => navigate(`/network/core/terminals/${params.row.id}/edit`)} sx={{ color: 'primary.main' }}>
