        ...
        <CardContent sx={{ p: 3 }}>
          ...
          <TabPanel value={activeTab} index={0}>
            <form onSubmit={handleSubmit}>
              <Stack spacing={3}>
                {/* ... KEEP ALL EXISTING FORM SECTIONS ... */}
                {/* (Code unchanged from original - Basic Info, Dates, Dimensions, Pressure, Capacity, Materials, Organizational, System & Terminals, Vendors) */}
                {/* Basic Information */}
                ...
                {/* Other sections omitted for brevity - they remain unchanged */}
              </Stack>
            </form>
          </TabPanel>
                      ...
                      <Table>
                        ...
                        <TableBody>
                          {segments.map((segment) => {
                            const hasInfraIssues = !segment.departureFacility || !segment.arrivalFacility;
                            const hasPositionIssues = (segment.startPoint === 0 && segment.endPoint === 0);
