...
const StationList = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'name', headerName: t('station.columns.name'), minWidth: 250, flex: 1, renderCell: (params) => <Typography variant="body2" fontWeight={500}>{params.value}</Typography> },
    { field: 'placeName', headerName: t('station.columns.location'), minWidth: 200, flex: 1 },
    {
      field: 'actions',
