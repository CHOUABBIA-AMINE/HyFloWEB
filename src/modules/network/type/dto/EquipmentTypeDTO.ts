/**
 * EquipmentType DTO - Network Type Module
 * 
 * Strictly aligned with backend: dz.sh.trc.hyflo.network.type.dto.EquipmentTypeDTO
 * 
 * Type entity with multilingual designations (Arabic, English, French)
 * Used to classify Equipment entities in the Network module.
 * 
...
/**
 * Validates EquipmentTypeDTO according to backend constraints
 */
export const validateEquipmentTypeDTO = (data: Partial<EquipmentTypeDTO>): string[] => {
  const errors: string[] = [];
