/**
 * TerminalType DTO - Network Type Module
 * 
 * Strictly aligned with backend: dz.sh.trc.hyflo.network.type.dto.TerminalTypeDTO
 * 
 * Type entity with multilingual designations (Arabic, English, French)
 * Used to classify Terminal entities in the Network module.
 * 
...
/**
 * Validates TerminalTypeDTO according to backend constraints
 */
export const validateTerminalTypeDTO = (data: Partial<TerminalTypeDTO>): string[] => {
  const errors: string[] = [];
