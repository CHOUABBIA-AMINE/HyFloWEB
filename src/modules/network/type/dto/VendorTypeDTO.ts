/**
 * VendorType DTO - Network Type Module
 * 
 * Strictly aligned with backend: dz.sh.trc.hyflo.network.type.dto.VendorTypeDTO
 * 
 * Type entity with multilingual designations (Arabic, English, French)
 * Used to classify Vendor entities in the Network module.
 * 
...
/**
 * Validates VendorTypeDTO according to backend constraints
 */
export const validateVendorTypeDTO = (data: Partial<VendorTypeDTO>): string[] => {
  const errors: string[] = [];
