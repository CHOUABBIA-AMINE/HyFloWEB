...
export class StructureService {
  ...
  static async getAll(pageable: Pageable): Promise<Page<StructureDTO>> {
    const response = await axiosInstance.get<Page<StructureDTO>>(BASE_URL, {
      params: {
        page: pageable.page,
        size: pageable.size,
        sort: pageable.sort,
  ...
  static async getAllNoPagination(): Promise<StructureDTO[]> {
    const response = await axiosInstance.get<StructureDTO[]>(`${BASE_URL}/all`);
    return response.data;
  }
  ...
  static async getById(id: number): Promise<StructureDTO> {
    const response = await axiosInstance.get<StructureDTO>(`${BASE_URL}/${id}`);
    return response.data;
  }
  ...
  static async create(dto: StructureDTO): Promise<StructureDTO> {
    const response = await axiosInstance.post<StructureDTO>(BASE_URL, dto);
    return response.data;
  }
  ...
  static async update(id: number, dto: StructureDTO): Promise<StructureDTO> {
    const response = await axiosInstance.put<StructureDTO>(`${BASE_URL}/${id}`, dto);
    return response.data;
  }
  ...
  static async globalSearch(
    ...
    const response = await axiosInstance.get<Page<StructureDTO>>(`${BASE_URL}/search`, {
      params: {
        q: searchTerm,
        page: pageable.page,
        size: pageable.size,
  ...
  static async getByStructureTypeId(structureTypeId: number): Promise<StructureDTO[]> {
    const response = await axiosInstance.get<StructureDTO[]>(`${BASE_URL}/by-type/${structureTypeId}`);
    return response.data;
  }
  ...
  static async getByParentStructureId(parentStructureId: number): Promise<StructureDTO[]> {
    const response = await axiosInstance.get<StructureDTO[]>(`${BASE_URL}/by-parent/${parentStructureId}`);
    return response.data;
  }
  ...
  static async getRootStructures(): Promise<StructureDTO[]> {
    const response = await axiosInstance.get<StructureDTO[]>(`${BASE_URL}/roots`);
    return response.data;
  }
}
