/**
 * Group List Page - ADVANCED PATTERN with Export & i18n
...
const GroupList = () => {
  ...
  const loadGroups = async () => {
    try {
      ...
      if (debouncedSearch) {
        pageResponse = await groupService.search(debouncedSearch, paginationModel.page, paginationModel.pageSize, sortField, sortDir);
      } else {
